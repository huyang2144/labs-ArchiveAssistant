...
class AiEnginePresetPreferencesTest {
    ...
    fun presetFromCurrentSettings_capturesAllFields() {
        ...
        val preset = AiEnginePresetPreferences.presetFromCurrentSettings(
            name = "Anthropic Work",
            settings = settings,
            rawApiKey = "sk-secret",
        )
    ...
    @Test
    fun repository_saveAndRead_loadsPersistedPresets() = kotlinx.coroutines.runBlocking {
    ...
    private class FakePreferencesDataStore : androidx.datastore.core.DataStore<androidx.datastore.preferences.core.Preferences> {
