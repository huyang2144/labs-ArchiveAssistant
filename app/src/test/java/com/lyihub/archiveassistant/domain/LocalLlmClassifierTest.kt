...
class LocalLlmClassifierTest {
  ...
  fun classifySuccess() = runTest {
    val classifier =
      classifierReturning("""{"topic": "Topic1", "confidence": 0.9, "reason": "match"}""")
  ...
  fun veryLongRawInput_doesNotCrashAndPreservesInput() = runTest {
    ...
    val classifier =
      classifierReturning("""{"topic": "Topic1", "confidence": 0.9, "reason": "long match"}""")
  ...
  fun confidenceOutOfRange_stillParsesMatchingTopic() = runTest {
    val classifier =
      classifierReturning("""{"topic": "Topic1", "confidence": 1.5, "reason": "match"}""")
  ...
  fun inferenceTimeout() = runTest {
    val engine =
      initializedEngine("""{"topic": "Topic1", "confidence": 0.9, "reason": "slow"}""").apply {
