...
object SampleKnowledgeData {
    ...
    val items: List<KnowledgeItem> = listOf(
        ...
        KnowledgeItem(
            ...
            fullText = "screenshot: original Transformer encoder-decoder architecture with multi-head attention, feed-forward layers, and positional encoding",
            sourceUrl = null,
            imageResName = "transformer_architecture",
